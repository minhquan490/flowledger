...
import io.flowledger.domain.transaction.validator.TransactionSplitMutationViewPayloadValidator;
import io.flowledger.domain.transaction.view.TransactionSplitView;
...
/**
 * Mutation-capable view for transaction splits.
 */
...
public interface TransactionSplitMutationView extends TransactionSplitView {
  /**
