...
/**
 * Validates mutation payloads for TransactionSplitMutationView.
 */
@Component
public class TransactionSplitMutationViewPayloadValidator extends JpaSchemaGraphQlMutationPayloadValidator {
