...
import io.flowledger.domain.transaction.validator.TransactionMutationViewPayloadValidator;
import io.flowledger.domain.transaction.view.TransactionView;
...
/**
 * Mutation-capable view for transactions.
 */
...
public interface TransactionMutationView extends TransactionView {
  /**
