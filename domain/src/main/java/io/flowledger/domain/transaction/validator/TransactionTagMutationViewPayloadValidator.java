...
/**
 * Validates mutation payloads for TransactionTagMutationView.
 */
@Component
public class TransactionTagMutationViewPayloadValidator extends JpaSchemaGraphQlMutationPayloadValidator {
