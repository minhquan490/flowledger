...
/**
 * Validates mutation payloads for UserSessionMutationView.
 */
@Component
public class UserSessionMutationViewPayloadValidator extends JpaSchemaGraphQlMutationPayloadValidator {
