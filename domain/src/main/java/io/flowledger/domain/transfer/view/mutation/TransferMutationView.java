package io.flowledger.domain.transfer.view.mutation;

import com.blazebit.persistence.view.CreatableEntityView;
import com.blazebit.persistence.view.EntityView;
import com.blazebit.persistence.view.UpdatableEntityView;
import io.flowledger.domain.transfer.aggregate.Transfer;
import io.flowledger.domain.transfer.validator.TransferMutationViewPayloadValidator;
import io.flowledger.domain.transfer.view.TransferView;
...
/**
 * Mutation-capable view for transfers.
 */
@EntityView(Transfer.class)
@CreatableEntityView
@UpdatableEntityView
@GraphQlModel(
    value = "transferMutation",
    mutationPolicy = RbacGraphQLMutationPolicy.class,
    mutationPayloadValidator = TransferMutationViewPayloadValidator.class
)
public interface TransferMutationView extends TransferView {
  /**
