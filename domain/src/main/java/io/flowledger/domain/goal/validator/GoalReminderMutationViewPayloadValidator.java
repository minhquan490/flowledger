...
/**
 * Validates mutation payloads for GoalReminderMutationView.
 */
@Component
public class GoalReminderMutationViewPayloadValidator extends JpaSchemaGraphQlMutationPayloadValidator {
